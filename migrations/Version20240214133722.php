 ...
 */
final class Version20240214133722 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE conversation ADD CONSTRAINT FK_8A8E26E94F34D596 FOREIGN KEY (ad_id) REFERENCES ads (id) ON DELETE SET NULL');
    }
